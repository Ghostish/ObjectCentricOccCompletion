...
def create_waymo_info_file(data_path,
    ...
    Modified by Zenn, enabling saving track id in anno info
    ...
    if save_path is None:
        ...
        save_path = Path(save_path)
    print(f'Pickle files will be save as: ', save_path / f'{pkl_prefix}_infos_train(val, test).pkl')
    waymo_infos_train = get_waymo_image_info(
        ...
        with_track_id=with_track_id,with_speed=with_speed)
