...
def create_groundtruth_database(dataset_class_name,
    ...
    elif dataset_class_name == 'WaymoDataset' or  dataset_class_name == 'MultiOccWaymoDataset':
        file_client_args = dict(backend='disk')
        dataset_cfg.update(
            test_mode=False,
            split='training',
    ...
    elif dataset_class_name == 'Argo2Dataset':
        file_client_args = dict(backend='disk')
        dataset_cfg.update(
            test_mode=False,
            split='training',
    ...
    for j in track_iter_progress(list(range(len(dataset)))):
        ...
        for i in range(num_obj):
            ...
            if (used_classes is None) or names[i] in used_classes:
                ...
                if 'track_id' in annos:
                    db_info['track_id'] = annos['track_id'][i]
