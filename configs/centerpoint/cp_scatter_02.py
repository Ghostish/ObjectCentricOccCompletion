...
model = dict(
    ...
    middle_encoder=dict(
        ...
        in_channels=  [16,        32,       64,       64,       64,       64,       64,         128,        256],
        feat_channels=[[32, 32], [32, 64], [64, 64], [64, 64], [64, 64], [64, 64], [128, 128], [128, 256], [256, 256]],
        window_sizes= [2, 2, 2, 2, 4, 4, 4, 4, 4],
        strides=[1, 2, 1, 1, 1, 2, 1, 2, 1],
        shifted=[True, False, True, False, True, False, True, False, True],
