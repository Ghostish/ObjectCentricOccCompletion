...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            num_classes=num_classes,
            num_blocks=6,
            in_channels=[25, 144, 144, 144, 144, 144],
            feat_channels=[
                [128, 128],
            ]
            * 6,
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            # ann_file="/LiZhen_team/dataset/waymo/tracklet_data/fsd6f6e_vehicle_full_training_gt_candidates.pkl",
            # tracklet_proposals_file="/LiZhen_team/dataset/waymo/tracklet_data/fsd6f6e_vehicle_full_training.pkl",
