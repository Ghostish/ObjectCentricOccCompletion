...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file="/LiZhen_team/dataset/waymo/tracklet_data/gt_base_vehicle_val_gt_candidates.pkl",
            # tracklet_proposals_file="/LiZhen_team/dataset/waymo/tracklet_data/fsd6f6e_vehicle_full_val.pkl",
            tracklet_proposals_file="/LiZhen_team/dataset/waymo/tracklet_data/gt_base_vehicle_val.pkl",
